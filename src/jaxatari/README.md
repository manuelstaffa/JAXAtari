...
| `../run.py` | Small command-line runner for a game, optional reward override, human play, and env modifications. Example: `python run.py -g Pong -hu -m lazy_enemy -rf score_delta` |
